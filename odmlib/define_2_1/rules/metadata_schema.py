...
class MetadataSchema(ConformanceChecker):
    ...
    def _set_metadata_registry():
        ...
        schema_registry.add(
            "WhereClauseRef", {"WhereClauseOID": {"type": "string", "required": True}}
        )

        schema_registry.add(
            "ValueListRef", {"ValueListOID": {"type": "string", "required": True}}
        )
        ...
        schema_registry.add(
            "SubClass", {"Name": {"type": "string"}, "ParentClass": {"type": "string"}}
        )
        ...
        schema_registry.add(
            "Origin",
            {
                ...
                "Source": {
                    "type": "string",
                    "allowed": ["Subject", "Investigator", "Vendor", "Sponsor"],
                },
                "DocumentRef": {
                    "type": "list",
                    "schema": {
        ...
        schema_registry.add(
            "ItemDef",
            {
                ...
                "Origin": {
                    "type": "list",
                    "schema": {"type": "dict", "schema": schema_registry.get("Origin")},
                },
                "ValueListRef": {
                    "type": "dict",
        ...
        schema_registry.add(
            "MetaDataVersion",
            {
                ...
                "leaf": {
                    "type": "list",
                    "schema": {"type": "dict", "schema": schema_registry.get("leaf")},
                },
            },
        )

        schema_registry.add(
            "StudyName", {"_content": {"type": "string", "required": True}}
        )

        schema_registry.add(
            "StudyDescription", {"_content": {"type": "string", "required": True}}
        )

        schema_registry.add(
            "ProtocolName", {"_content": {"type": "string", "required": True}}
        )
