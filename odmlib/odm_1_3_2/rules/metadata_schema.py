    ...
    def _set_metadata_registry():
        ...
        schema_registry.add(
            "Protocol",
            {
                ...
                "StudyEventRef": {
                    ...
                    "schema": {
                        "type": "dict",
                        "schema": schema_registry.get("StudyEventRef"),
                    },
                },
                "Alias": {
                    "type": "list",
                    "schema": {"type": "dict", "schema": schema_registry.get("Alias")},
                },
            },
        )
        ...
        schema_registry.add(
            "StudyEventDef",
            {
                ...
                "Type": {
                    "type": "string",
                    "allowed": ["Scheduled", "Unscheduled", "Common"],
                },
                ...
                "FormRef": {
                    ...
                    "schema": {
                        "type": "dict",
                        "schema": schema_registry.get("FormRef"),
                    },
                },
                "Alias": {
                    "type": "list",
        ...
        schema_registry.add(
            "FormDef",
            {
                ...
                "ItemGroupRef": {
                    ...
                    "schema": {
                        "type": "dict",
                        "schema": schema_registry.get("ItemGroupRef"),
                    },
                },
                "ArchiveLayout": {
                    "type": "list",
                    "schema": {
                        "type": "dict",
                        "schema": schema_registry.get("ArchiveLayout"),
                    },
                },
                "Alias": {
                    "type": "list",
        ...
        schema_registry.add(
            "RangeCheck",
            {
                "Comparator": {
                    "type": "string",
                    "allowed": ["LT", "LE", "GT", "GE", "EQ", "NE", "IN", "NOTIN"],
                },
                ...
                "MeasurementUnitRef": {
                    "type": "dict",
                    "schema": schema_registry.get("MeasurementUnitRef"),
                },
                "ErrorMessage": {
                    "type": "dict",
                    "schema": {
        ...
        schema_registry.add(
            "CodeListRef", {"CodeListOID": {"type": "string", "required": True}}
        )
        ...
        schema_registry.add(
            "ItemDef",
            {
                ...
                "ExternalQuestion": {
                    "type": "dict",
                    "schema": schema_registry.get("ExternalQuestion"),
                },
                "MeasurementUnitRef": {
                    "type": "list",
                    "schema": {
        ...
        schema_registry.add(
            "MethodDef",
            {
                ...
                "Type": {
                    "type": "string",
                    "required": True,
                    "allowed": ["Computation", "Imputation", "Transpose", "Other"],
                },
                "Description": {
                    "type": "dict",
                    "required": True,
        ...
        schema_registry.add(
            "MetaDataVersion",
            {
                ...
                "StudyEventDef": {
                    ...
                    "schema": {
                        "type": "dict",
                        "schema": schema_registry.get("StudyEventDef"),
                    },
                },
                "FormDef": {
                    "type": "list",
                    "schema": {
                        "type": "dict",
                        "schema": schema_registry.get("FormDef"),
                    },
                },
                "ItemGroupDef": {
                    "type": "list",
                ...
                "ConditionDef": {
                    ...
                    "schema": {
                        "type": "dict",
                        "schema": schema_registry.get("ConditionDef"),
                    },
                },
                "MethodDef": {
                    "type": "list",
        ...
        schema_registry.add(
            "BasicDefinitions",
            {
                "MeasurementUnit": {
                    ...
                    "schema": {
                        "type": "dict",
                        "schema": schema_registry.get("MeasurementUnit"),
                    },
                }
            },
        )
        ...
        schema_registry.add(
            "Study",
            {
                ...
                "GlobalVariables": {
                    ...
                    "schema": {
                        "StudyName": {
                            "schema": {"_content": {"type": "string", "required": True}}
                        },
                        "StudyDescription": {
                            "schema": {"_content": {"type": "string", "required": True}}
                        },
                ...
                "BasicDefinitions": {
                    "type": "dict",
                    "schema": schema_registry.get("BasicDefinitions"),
                },
                "MetaDataVersion": {
                    "type": "list",
                    "schema": {
        ...
        schema_registry.add(
            "ODM",
            {
                ...
                "Study": {
                    "type": "list",
                    "schema": {"type": "dict", "schema": schema_registry.get("Study")},
                },
            },
        )
