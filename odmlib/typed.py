...
class DateTimeString(DESC.Descriptor):
    def __set__(self, instance, value):
        iso_pat = r"^(-?(?:[1-9][0-9]*)?[0-9]{4})-(1[0-2]|0[1-9])-(3[01]|0[1-9]|[12][0-9])T(2[0-3]|[01][0-9]):([0-5][0-9]):([0-5][0-9])(\.[0-9]+)?(Z|[+-](?:2[0-3]|[01][0-9]):[0-5][0-9])?$"  # noqa: 501
...
class PartialDateTimeString(DESC.Descriptor):
    def __set__(self, instance, value):
        part_pat = r"^((([0-9][0-9][0-9][0-9])((-(([0][1-9])|([1][0-2])))((-(([0][1-9])|([1-2][0-9])|([3][0-1])))(T((([0-1][0-9])|([2][0-3]))((:([0-5][0-9]))(((:([0-5][0-9]))((\.[0-9]+)?))?)?)?((((\+|-)(([0-1][0-9])|([2][0-3])):[0-5][0-9])|(Z)))?))?)?)?))$"  # noqa: 501
...
class PartialTimeString(DESC.Descriptor):
    def __set__(self, instance, value):
        ...
        if (value is not None) and (
            not (compiled_time_pat.match(value) or compiled_part_pat.match(value))
        ):
            raise ValueError(
...
class IncompleteDateTimeString(DESC.Descriptor):
    def __set__(self, instance, value):
        inc_pat = r"^(((([0-9][0-9][0-9][0-9]))|-)-(((([0][1-9])|([1][0-2])))|-)-(((([0][1-9])|([1-2][0-9])|([3][0-1])))|-)T(((([0-1][0-9])|([2][0-3])))|-):((([0-5][0-9]))|-):((([0-5][0-9](\.[0-9]+)?))|-)((((\+|-)(([0-1][0-9])|([2][0-3])):[0-5][0-9])|Z|-))?)$"  # noqa: 501
...
class IncompleteDateString(DESC.Descriptor):
    def __set__(self, instance, value):
        inc_pat = r"^(((([0-9][0-9][0-9][0-9]))|-)-(((([0][1-9])|([1][0-2])))|-)-(((([0][1-9])|([1-2][0-9])|([3][0-1])))|-))$"  # noqa: 501
        compiled_inc_pat = re.compile(inc_pat)
        if (value is not None) and (not compiled_inc_pat.match(value)):
            raise ValueError(
...
class IncompleteTimeString(DESC.Descriptor):
    def __set__(self, instance, value):
        inc_pat = r"^((((([0-1][0-9])|([2][0-3])))|-):((([0-5][0-9]))|-):((([0-5][0-9](\.[0-9]+)?))|-)((((\+|-)(([0-1][0-9])|([2][0-3])):[0-5][0-9])|Z|-))?)$"  # noqa: 501
        compiled_inc_pat = re.compile(inc_pat)
        if (value is not None) and (not compiled_inc_pat.match(value)):
            raise ValueError(
                f"Expected type IncompleteTime for {self.name}, found value {value}"
...
class ValidValues(DESC.Descriptor):
    def __set__(self, instance, value):
        if (value is not None) and value not in VS.ValueSet.value_set(
