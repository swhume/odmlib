...
class TestAttributeOrder(unittest.TestCase):
    ...
    def test_study_invalid_study_object_assignment(self):
        ...
        with self.assertRaises(TypeError):
            study.GlobalVariables.StudyName = ODM.ProtocolName(
                _content="The ODM protocol name")

    def test_valid_order_study_objects(self):
        study = ODM.Study(OID="ST.001.Test")
        study.GlobalVariables = ODM.GlobalVariables()
        study.GlobalVariables.StudyName = ODM.StudyName(
            _content="The ODM study name")
        study.GlobalVariables.StudyDescription = ODM.StudyDescription(
            _content="The description of the ODM study")
        study.GlobalVariables.ProtocolName = ODM.ProtocolName(
            _content="The ODM protocol name")
    ...
    def test_odm_order_incomplete(self):
        ...
        odm.Study[0].GlobalVariables.StudyName = ODM.StudyName(
            _content="The ODM study name")
        odm.Study[0].GlobalVariables.StudyDescription = ODM.StudyDescription(
            _content="The description of the ODM study")
        odm.Study[0].GlobalVariables.ProtocolName = ODM.ProtocolName(
            _content="The ODM protocol name")
    ...
    def test_odm_order_multiple(self):
        ...
        fd1.Description.TranslatedText.append(ODM.TranslatedText(
            lang="en", _content="this is the test description"))
        fd1.ItemGroupRef.append(ODM.ItemGroupRef(
        ...
        fd2 = ODM.FormDef(
            OID="ODM.F.DM", Name="Demographics Form", Repeating="No")
        fd3 = ODM.FormDef(
            OID="ODM.F.AE", Name="Adverse Events Form", Repeating="Yes")
