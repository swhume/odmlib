...
class TestConformanceCheckODM(TestCase):
    ...
    def test_MethodDef_missing_Description(self):
        ...
        md1 = ODM.MethodDef(OID="ODM.MT.AGE", Name="Algorithm to dervive AGE",
                            Type="Computation", Description=desc1)
        ...
        self.assertEqual(self.mdv.MethodDef[0].Description.TranslatedText[0]._content,
    ...
    def add_IGD_refdef(self):
        itr1 = ODM.ItemRef(ItemOID="ODM.IT.VS.VSDAT", Mandatory="Yes")
        itr2 = ODM.ItemRef(
            ItemOID="ODM.IT.VS.BP.DIABP.VSORRES_BAD", Mandatory="Yes")
        itr3 = ODM.ItemRef(
            ItemOID="ODM.IT.VS.BP.SYSBP.VSORRES", Mandatory="Yes")
        igd1 = ODM.ItemGroupDef(
            OID="ODM.IG.VS", Name="Vital Sign Measurement", Repeating="Yes")
