...
class TestMetaDataVersion(TestCase):
    def setUp(self) -> None:
        ...
        self.odm_test_file = os.path.join(os.path.dirname(
            os.path.realpath(__file__)), 'data', 'test_mdv_001.xml')

    def test_add_include(self):
        inc = ODM.Include(StudyOID="STUDY.TRACE-XML-DEMO",
                          MetaDataVersionOID="MDV.TRACE-XML-ODM-01")
    ...
    def test_add_protocol(self):
        ...
        self.assertEqual(
            self.mdv.Protocol.StudyEventRef[1].StudyEventOID, "FOLLOW-UP")
        self.assertEqual(
            self.mdv.Protocol.Description.TranslatedText[0]._content, "Trace-XML Test CDASH File")
    ...
    def test_add_studyeventdef(self):
        ...
        self.assertEqual(
            self.mdv.StudyEventDef[1].FormRef[2].FormOID, 'ODM.F.AE')
    ...
    def test_add_formdef(self):
        ...
        self.assertEqual(
            self.mdv.FormDef[0].ItemGroupRef[2].ItemGroupOID, 'ODM.IG.VS')
    ...
    def test_add_itemgroupdef(self):
        ...
        self.assertEqual(
            self.mdv.ItemGroupDef[0].ItemRef[2].ItemOID, 'ODM.IT.VS.BP.SYSBP.VSORRES')
    ...
    def test_add_itemdef(self):
        ...
        self.assertEqual(
            "Diastolic", self.mdv.ItemDef[1].Question.TranslatedText[0]._content)
    ...
    def test_add_codelist(self):
        ...
        self.assertEqual(
            "Yes", self.mdv.CodeList[0].CodeListItem[1].Decode.TranslatedText[0]._content)
    ...
    def test_add_methoddef(self):
        ...
        self.assertEqual("Concatenation of BRTHYR, BRTHMO, and BRTHDY in ISO 8601 format",
    ...
    def test_add_conditiondef(self):
        ...
        self.assertEqual("Skip the BRTHMO field when BRTHYR length NE 4",
                         self.mdv.ConditionDef[0].Description.TranslatedText[0]._content)

    def test_add_presentation(self):
        p = ODM.Presentation(OID="ODM.PR.CRF.DM",
                             lang="en", _content="stylesheet")
