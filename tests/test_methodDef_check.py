...
class TestMethodDefCheck(TestCase):
    def setUp(self) -> None:
    ...
    def test_no_description(self):
        ...
        self.methoddef.FormalExpression = [ODM.FormalExpression(
            Context="Python 3.7", _content="print('hello world')")]
        self.assertEqual(
            self.methoddef.FormalExpression[0]._content, "print('hello world')")
    ...
    def test_add_description(self):
        ...
        tt2 = ODM.TranslatedText(
            _content="For the complete algorithm see the referenced external document.", lang="fr")
