...
class TestODM(TestCase):
    def setUp(self) -> None:
        ...
        self.odm_test_file = get_data_file_path("test_odm_001.xml")
        self.odm_writer_test_file = get_data_file_path("test_odm_002.xml", check_exists=False)
        self.loader = LD.ODMLoader(OL.XMLODMLoader())

    def tearDown(self) -> None:
        if os.path.exists(self.odm_writer_test_file):
            os.remove(self.odm_writer_test_file)
