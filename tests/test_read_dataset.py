...
class TestReadDataset(unittest.TestCase):
    ...
    def test_open_odm_document(self):
        ...
        self.assertEqual(
            self.odm.ClinicalData.ItemGroupData[0].ItemGroupOID, "IG.AE")
        self.assertEqual(
            self.odm.ClinicalData.ItemGroupData[0].ItemData[2].Value, "CDISC01.100008")
        self.assertEqual(
            self.odm.ClinicalData.ItemGroupData[1].ItemData[4].Value, "ANXIETY")
