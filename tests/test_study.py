...
class TestStudy(TestCase):
    ...
    def test_full_study(self):
        ...
        study_desc = ODM.StudyDescription(
        ...
        self.assertEqual(
            self.study.GlobalVariables.StudyName._content, "The ODM study name")

    def test_study_dict(self):
        self.study.GlobalVariables = ODM.GlobalVariables()
        self.study.GlobalVariables.StudyName = ODM.StudyName(
            _content="The ODM study name")
        self.study.GlobalVariables.StudyDescription = ODM.StudyDescription(
            _content="The description of the ODM study")
        self.study.GlobalVariables.ProtocolName = ODM.ProtocolName(
