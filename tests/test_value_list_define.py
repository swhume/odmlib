...
class TestValueListDef(TestCase):
    def test_value_list_def(self):
        ...
        vld.ItemRef.append(DEFINE.ItemRef(
            ItemOID="IT.DA.DAORRES.DISPAMT", OrderNumber="1", Mandatory="Yes"))
        vld.ItemRef[0].WhereClauseRef.append(
            DEFINE.WhereClauseRef(WhereClauseOID="WC.DA.DATESTCD.DISPAMT"))
        vld.ItemRef.append(DEFINE.ItemRef(
            ItemOID="IT.DA.DAORRES.RETAMT", OrderNumber="2", Mandatory="No"))
    ...
    def test_where_clause_def(self):
        ...
        wcd.RangeCheck.append(DEFINE.RangeCheck(
            SoftHard="Soft", ItemOID="IT.DA.DATESTCD", Comparator="EQ"))
        wcd.RangeCheck[0].CheckValue.append(
            DEFINE.CheckValue(_content="DISPAMT"))
    ...
    def test_comment_def(self):
        ...
        comment.Description.TranslatedText.append(DEFINE.TranslatedText(
            _content="Assigned from the TV domain based on the VISIT", lang="en"))
